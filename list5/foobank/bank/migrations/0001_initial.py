    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acc_num_from', models.CharField(max_length=28, verbose_name='from account number')),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='PLN', max_digits=12, verbose_name='transfer amount')),
                ('acc_num_to', models.CharField(max_length=28, verbose_name='to account number')),
                ('rec_name', models.CharField(max_length=120, verbose_name='receiver name')),
                ('rec_street', models.CharField(max_length=64, verbose_name='street')),
                ('rec_pcode', models.CharField(max_length=6, verbose_name='postcode')),
                ('rec_city', models.CharField(max_length=32, verbose_name='city')),
                ('title', models.TextField(max_length=140, verbose_name='title')),
                ('post_time', models.DateTimeField(auto_now_add=True, verbose_name='transfer date')),
